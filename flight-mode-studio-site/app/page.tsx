    ...
    <>
      ...
      <section className="why">
        <div className="why__left">
          ...
          <h2 className="section-title">Content should not feel like a full production.</h2>
        </div>
      ...
      <section className="how" id="how-it-works">
        ...
        <h2 className="section-title">A ridiculously simple way to get content every month.</h2>
      ...
      <section className="features">
        <div className="features__header">
          <div className="features__header-left">
            ...
            <h2 className="section-title">Made for brands that need speed, volume, and results.</h2>
          </div>
      ...
      <section className="cta">
        <div className="cta__card">
          ...
          <h2 className="cta__title">Let's turn your business into a content machine.</h2>
